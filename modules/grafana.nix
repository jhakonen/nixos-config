# Toteutus on kopioitu ja muokattu osoitteesta:
#   https://github.com/NixOS/nixpkgs/blob/0a5cb5c47eb06f4150bd5a5ade7c2a9e28ee03a6/nixos/modules/services/monitoring/grafana.nix
# Virallinen Grafan palvelu ei salli lisätä konfiguraatiota auth.anonymous asetuksille
# joten täytyy tehdä itse
...
let
  ...
  configFile = pkgs.writeText "config.ini" ''
    ...
    static_root_path = ${pkgs.grafana}/share/grafana/public
  ...
  config = mkIf cfg.enable {
    ...
    systemd.services.grafana = {
      ...
      script = ''
        ...
        exec ${pkgs.grafana}/bin/grafana-server -homepath ${dataDir} -config ${configFile}
      '';
      serviceConfig = {
      ...
      preStart = ''
        ln -fs ${pkgs.grafana}/share/grafana/conf ${dataDir}
        ln -fs ${pkgs.grafana}/share/grafana/tools ${dataDir}
      '';
    };
